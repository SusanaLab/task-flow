...
class Proyecto:
    ...
    def __init__(
        self, nombre: str, descripcion: str = "", id: int = None, estado: str = "Activo"
    ):
...
class Tarea:
    ...
    # *Algoritmo de Comportamiento (Método), para cambiar el estatus*
    ...
    # *hace cambio para que sea un diccionario para la base de datos*
    def to_dict(self):
        return {
            "id": self._id,
            "titulo": self._titulo,
